...
import kvityData from '../../assets/data/kvity.json';
import kushchiData from '../../assets/data/kushchi.json';
import plovodiData from '../../assets/data/plodovi.json';
import dekoratyvniData from '../../assets/data/dekoratyvni.json';
